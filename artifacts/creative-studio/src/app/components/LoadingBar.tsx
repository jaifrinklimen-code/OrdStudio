  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        boxShadow: '0 0 14px rgba(167,139,250,0.9), 0 0 30px rgba(124,58,237,0.5)',
        borderRadius: '0 2px 2px 0',
        transition: width === 0 ? 'none' : 'width 0.5s cubic-bezier(0.1, 0.6, 0.3, 1)',
        opacity: fading ? 0 : 1,
        transitionProperty: fading ? 'opacity' : 'width',
        transitionDuration: fading ? '0.3s' : '0.5s',
      }} />
      {/* Leading glow dot */}
      <div style={{
        position: 'absolute',
